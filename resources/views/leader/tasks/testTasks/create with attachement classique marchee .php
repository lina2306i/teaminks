        ...
        <div class="col-xl-10 col-lg-11">
            ...
            <div class="card bg-gray-800 text-white shadow-2xl border-0 rounded-xl">
                <div class="card-body p-5 p-md-6">
                    ...
                    <form action="{{ route('leader.tasks.store') }}" method="POST" id="create-task-form" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <!-- Attachments -->
                        <div class="mb-5">
                            <label class="form-label fw-semibold"><i class="fas fa-paperclip me-2"></i>Upload files</label>
                            ...
                            <hr>
                           {{-- <div x-data="attachments()" class="border border-gray-600 rounded-lg p-4 bg-gray-700">
                                <!-- Zone de drop -->
                                <div class="border-2 border-dashed border-gray-600 rounded-lg p-6 text-center cursor-pointer hover:border-primary transition"
                                    @click="$refs.fileInput.click()"
                                    @dragover.prevent
                                    @drop.prevent="handleDrop($event)">
                                    <input type="file" x-ref="fileInput" class="hidden" multiple @change="handleFiles($event)">
                                    <i class="fas fa-cloud-upload-alt text-4xl text-gray-400 mb-3"></i>
                                    <p class="text-gray-400 mb-1">Drag & drop files here or click to browse</p>
                                    <p class="text-gray-500 text-sm">Max 10MB per file – PDF, images, docs, etc.</p>
                                </div>
                                ...
                                <div class="mt-4 space-y-2" x-show="files.length > 0">
                                    <template x-for="(file, index) in files" :key="index">
                                        <div class="flex items-center justify-between bg-gray-800 p-3 rounded-lg">
                                            ...
                                            <button type="button" class="text-danger hover:text-red-400" @click="removeFile(index)">
...
@push('scripts')
  ...
  {{-- -  <script>
        //Alpine.js pour gérer les uploads en Ajax :: Version finale avec attachments + Ajax
