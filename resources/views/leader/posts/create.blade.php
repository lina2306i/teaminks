                        ...
                        <form action="{{ route('leader.posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            @else
                                <div class="alert alert-warning mb-4">
                                    You haven't created a team yet. <a href="{{-- route('leader.team.create') --}}" class="text-info">Create one</a>.
                                </div>
                            @endif
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="content"
                                          ...
                                          rows="6"
                                          class="form-control bg-gray-700 border-gray-600 text-white"
                                          placeholder="What's new in the team? Share an update, idea, or achievement..."
