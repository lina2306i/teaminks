                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div id="dropZone" class="border border-2 border-dashed rounded p-4 text-center"
                                        ...
                                        <div id="dropZoneContent">
                                            ...
                                            <p class="mt-3 mb-2 fw-bold">Glissez-déposez vos fichiers ici</p>
                                            ...
                                            <p class="mt-3 small text-muted">Maximum 5 fichiers - 10MB par fichier</p>
                                        </div>
                                    </div> <hr>
                                     {{-- Alternative simple avec le même style visuel que FilePond --}}
                                    <div id="dropZone" class="bg-gray-700 border border-2 border-dashed border-gray-600 rounded-xl p-5 text-center position-relative"
                                        ...
                                        <div id="dropZoneContent" class="py-4">
                                            ...
                                            <p class="text-sm text-gray-400">ou
                                                <span class="text-primary" style="text-decoration: underline;">cliquez pour parcourir</span>
                                            </p>
